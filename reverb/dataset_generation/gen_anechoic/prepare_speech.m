%% Params
fname = '/mnt/40086D4C086D41D0/Reverb_normative/Sounds/Anechoic_speech/To_use_cropped/Individual_new';
fs_desired = 44100;
total_stim_s = 245; %How long I want the total duration of all the stimuli in s
...
snd = snd./max(abs(snd(:)));
save_name = fullfile(snd_files(1).folder,['Speech_all.wav']);
