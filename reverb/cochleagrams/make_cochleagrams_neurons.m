stim_dir = '/mnt/40086D4C086D41D0/Reverb_neuronal_data/Cochleagrams/Sound_stim/Ronnie_PLP';
...
for s = 1:n_stim
    ...
    if strcmp(exp_name,'Derry_Kilkenny_Cork')
...
coch(1).reverb_cond = 'anech1';
coch(2).reverb_cond = 'anech2';
coch(3).reverb_cond = 'small1';
coch(4).reverb_cond = 'small2';
