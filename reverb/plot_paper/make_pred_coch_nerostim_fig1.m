...
for r = 1:6
    ...
    ylabel('Freqeuncy [kHz]','FontSize',14,'FontWeight','bold');
end
set(gcf,'color','w');
...
xticks([1:dt_samples:length(t)]);
xticklabels(x_labels);
xlabel('Time [s]','FontSize',x_font_sz,'FontWeight','bold');
ylabel('Freqeuncy [kHz]','FontSize',y_font_sz,'FontWeight','bold');
set(gca,'FontSize',all_font_sz,'FontWeight','Bold');
set(gcf,'color','w');
save_name = fullfile(save_dir,'Anechoic_coch_example.png');
export_fig(save_name);
close all;
...
set(gca,'FontSize',all_font_sz,'FontWeight','Bold');
set(gcf,'color','w');
save_name = fullfile(save_dir,'Small_coch_example.png');
export_fig(save_name);
close all;
...
set(gca,'FontSize',all_font_sz,'FontWeight','Bold');
set(gcf,'color','w');
save_name = fullfile(save_dir,'Big_coch_example.png');
export_fig(save_name);
close all;
...
set(gca,'FontSize',all_font_sz,'FontWeight','Bold');
set(gcf,'color','w');
save_name = fullfile(save_dir,'Small_pred_anechoic_coch_example.png');
export_fig(save_name);
close all;
...
set(gca,'FontSize',all_font_sz,'FontWeight','Bold');
set(gcf,'color','w');
save_name = fullfile(save_dir,'Big_pred_anechoic_coch_example.png');
export_fig(save_name);
close all;
...
set(ht,'Rotation',-90,'FontSize',sz,'FontWeight','bold','FontName',font_type);
yticks([1:skip_f:n_f]);
yticklabels(y_labels);
xticks([1:dt_samples:length(t)]);
xticklabels(x_labels);
...
set(gca,'FontSize',all_font_sz,'FontWeight','Bold');
set(gcf,'color','w');
save_name = fullfile(save_dir,'Colorbar.png');
export_fig(save_name);
close all;