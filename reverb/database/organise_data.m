...
%proper cut-and-paste of the date. There will also be other critical infor
%like NPSP, good/bad, channel number
%% Define params
NPSP_th = 200; %The threshold for selecting the neurons
main_dir = '/mnt/40086D4C086D41D0/Reverb_data/For_analysis/sahani_done'; %The folder with all the animals
save_dir = '/mnt/40086D4C086D41D0/Reverb_data/For_analysis/All_data'; %Where we will store all the data
