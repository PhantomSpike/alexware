...
xlabel('100*(\tau_{large}- \tau_{small})/(\tau_{big} + \tau_{small}) [Cetner of mass change index]','FontSize',x_font_sz,'FontWeight','bold');
ylabel('Number of kernels','FontSize',y_font_sz,'FontWeight','bold');
