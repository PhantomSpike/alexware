function kernel =  gen_lnp_kernel(coch_in,y,h_max_ms,model,normz,kfold)
...
y_t_reverb = [y_temp(3,:),y_temp(4,:),y_temp(5,:),y_temp(6,:)];
...
if kfold
    ...
    %Small Room
    kernel.anech = run_model(anech_X_fht,y_t_anech,model);
    %Medium Room
