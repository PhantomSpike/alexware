...
rootdir='F:\Ioanna\22_03_2019\P2\Gaps';
...
hold on
load F:\Ioanna\22_03_2019\P2\Clicks\clust_info.mat %%load cluster info
load('C:\Users\Ioanna\Desktop\10_04_2019\Results\significant_all_rates_P2.mat')
...
hx = xlabel('Time (ms)');
yt=get(gca,'ytick');
set(gca,'yticklabel',[ 1910        1710        1510        1310        1110         910         710])
