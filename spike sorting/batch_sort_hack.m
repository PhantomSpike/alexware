...
% groupSize = 24; % for CRA
Chan_border = 150;


pen_root = '/media/alex/5FC39EAD5A6AA312/MSc_students/For_sorting/'; % folder containing all stimuli to be sorted, aranged in 1 folder per penetration, with 1 config folder for this peentration and cthe stimuli from that penetration in separate folders
...
for pen = 1:numel(penList)
    ...
    for stim = 1:numel(stimList)
        ...
        if cra_on
            ...
            process_raw_spikedata_hack(fpath,ChanTotal,Chan_border);
        end
